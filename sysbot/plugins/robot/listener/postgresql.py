...
Example:
    robot --listener sysbot.plugins.robot.listener.postgresql.Postgresql:postgresql://postgres:password@localhost/test_results:Sprint42 tests/
...
class Postgresql:
    ...
    def _connect(self):
        ...
        Raises:
            Exception: If connection to PostgreSQL database fails.
        """
        try:
