...
class Openid(ConnectorInterface):
    """
    HTTP/HTTPS connector with OpenID Connect authentication.
    """

    def open_session(self, host, port, login=None, password=None, **kwargs):
        """
        Opens an HTTP/HTTPS session with OpenID Connect authentication.
        ...
        Args:
            ...
            **kwargs: Additional parameters:
                ...
                - access_token: OIDC access token (required)
                - openid_discovery_url: OpenID Connect discovery URL (optional)
        ...
        openid_discovery_url = kwargs.get('openid_discovery_url')
        
        if not access_token:
            raise ValueError("OpenID Connect access token is required")
    ...
    def execute_command(self, session, command, options=None):
        """
        Executes an HTTP request with OpenID Connect authentication.
