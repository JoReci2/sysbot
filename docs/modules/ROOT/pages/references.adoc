...
<<<<<<< HEAD
<<<<<<< HEAD
  - HTTP: "none", "basic", "apikey", "bearer", "jwt", "oauth1", "oauth2", "hmac", "certificate", "openid", "saml"
=======
  - HTTP: "generic", "basicauth", "vsphere"
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
=======
  - HTTP: "http"
...
<<<<<<< HEAD
<<<<<<< HEAD
* **Products**: Each authentication method is a separate product
  ...
  - "certificate": Client certificate authentication (mutual TLS)
  - "openid": OpenID Connect authentication
  - "saml": SAML authentication

==== HTTP Connector Classes

Each authentication method has its own dedicated class:

* **None_**: No authentication - for public APIs
* **Basic**: HTTP Basic Authentication with username/password
* **Apikey**: API Key in header or query parameter
* **Bearer**: Bearer token (pre-obtained)
* **Jwt**: JWT with automatic token generation
* **Oauth1**: OAuth 1.0 with consumer keys
* **Oauth2**: OAuth 2.0 with access tokens
* **Hmac**: HMAC signature-based authentication
* **Certificate**: Client certificate (mutual TLS)
* **Openid**: OpenID Connect with access token
* **Saml**: SAML with pre-obtained assertion
=======
* **Products**: "generic", "basicauth", "vsphere"
=======
* **Product**: "http"
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
* **Authentication Methods**: none, basic, apikey, bearer, jwt, oauth1, oauth2, hmac, certificate, openid, saml

==== HTTP Connector

The HTTP connector supports multiple authentication methods and both HTTP and HTTPS protocols.
...
* **saml**: SAML authentication (placeholder)
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "none", "api.example.com", 443,
                protocol="https")
----
...
[source,python]
----
bot.open_session("api", "http", "basic", "api.example.com", 443,
                "user", "pass", protocol="https")
----

=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
...
# Or use the backward-compatible basicauth connector
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "apikey", "api.example.com", 443,
                login="your-api-key", protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                login="your-api-key", protocol="https", auth_method="apikey",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
                api_key_name="X-API-Key", api_key_location="header")
----
...
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                login="your-api-key", protocol="https", auth_method="apikey",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
                api_key_name="api_key", api_key_location="query")
----
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "bearer", "api.example.com", 443,
                protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                protocol="https", auth_method="bearer",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "jwt", "api.example.com", 443,
                login="username", password="jwt-secret",
                protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
...
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                login="username", password="jwt-secret",
                protocol="https", auth_method="jwt",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
                jwt_algorithm="HS256", jwt_expiry=3600,
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "oauth1", "api.example.com", 443,
                protocol="https",
                login="consumer_key",
...
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                protocol="https", auth_method="oauth1",
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "oauth2", "api.example.com", 443,
                protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                protocol="https", auth_method="oauth2",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "hmac", "api.example.com", 443,
                password="hmac-secret", protocol="https",
...
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                password="hmac-secret", protocol="https",
                auth_method="hmac", hmac_algorithm="sha256")
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
----
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "certificate", "api.example.com", 443,
                protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                protocol="https", auth_method="certificate",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "openid", "api.example.com", 443,
                protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                protocol="https", auth_method="openid",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
                access_token="your-access-token",
                openid_discovery_url="https://provider.example.com/.well-known/openid-configuration")
----
...
<<<<<<< HEAD
<<<<<<< HEAD
bot.open_session("api", "http", "saml", "api.example.com", 443,
                protocol="https",
=======
bot.open_session("api", "http", "generic", "api.example.com", 443,
=======
bot.open_session("api", "http", "http", "api.example.com", 443,
>>>>>>> e8aec21 (Refactor: move HTTP connector to single file sysbot/connectors/http.py with Http class)
                protocol="https", auth_method="saml",
>>>>>>> 87a4e97 (Add comprehensive documentation for HTTP connector)
...
[source,python]
----
bot.open_session("vcenter", "http", "vsphere", "vcenter.example.com",
