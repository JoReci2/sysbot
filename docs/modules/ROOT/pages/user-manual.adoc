...
robot --listener sysbot.plugins.robot.listener.bdd.Bdd:sqlite:/tmp/test_results.db:MyProject tests/
----
...
robot --listener sysbot.plugins.robot.listener.bdd.Bdd:mysql:user:password@localhost/testdb:MyCampaign tests/

# With custom port
robot --listener sysbot.plugins.robot.listener.bdd.Bdd:mysql:user:password@localhost:3307/testdb:MyCampaign tests/
----
...
robot --listener sysbot.plugins.robot.listener.bdd.Bdd:postgresql:user:password@localhost/testdb:MyCampaign tests/

# With custom port
robot --listener sysbot.plugins.robot.listener.bdd.Bdd:postgresql:user:password@localhost:5433/testdb:MyCampaign tests/
----
...
# With authentication
robot --listener sysbot.plugins.robot.listener.bdd.Bdd:mongodb:user:password@localhost:27017/testdb:MyCampaign tests/
----
